  ...
  var html = React.renderToString(
    React.createElement("html", null, 
      React.createElement("head", null, 
        ...
        React.createElement("script", {src: "//fb.me/JSXTransformer-0.13.1.js"}), 
        React.createElement("script", {src: "/Components/Timestamp.jsx", type: "text/jsx"})
      ), 
      React.createElement("body", null, 
        React.createElement(HelloWorld, {from: "index.jsx on the server"}), 
        React.createElement("div", {id: "reactContainer"})
      ), 
      React.createElement("script", {src: "/assets/index.js", type: "text/jsx"})
    ))
